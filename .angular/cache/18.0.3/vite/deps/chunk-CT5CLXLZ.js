...
import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-VDHW6CTY.js";
import {
  firebase
} from "./chunk-EXBBCFH2.js";
import {
  VERSION,
...
import {
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-LIDJECYM.js";
import {
  __async
} from "./chunk-YL4Z5MXS.js";
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-ZLFRLO2I.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
@firebase/app-check/dist/esm/index.esm2017.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CT5CLXLZ.js.map
